...
const eraShowcases: ProductData[] = [
  ...
  {
    id: 'building', label: '2021 – 2024', title: 'University & Products',
    description: 'ESCP Business School across Paris, Turin, and Lisbon. Built SchoolSpirit, AI Photo Agency, and early prototypes that evolved into TRU SYNTH. Google internship in Turin.',
